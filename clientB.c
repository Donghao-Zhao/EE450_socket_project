...
#define PORT_CENTRAL_TCP_B          "26890"     // the port clientB will be connecting to
...
int main(int argc, char *argv[])
{
    ...
    if ((rv = getaddrinfo(CENTRAL_IP, PORT_CENTRAL_TCP_B, &hints, &servinfo)) != 0)
    {
    ...
    printf("\nThe client sent %s to the Central server.\n", argv[1]);
